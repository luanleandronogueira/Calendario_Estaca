...
<main>
    ...
    <section id="services" class="services">
        <div class="section-title">
            <h3>Tem certeza que quer deletar a visita <span> <em><?=$Resultado[0]['titulo_visita']?></em> ?</span></h3> <br>
            <div>
                <a href="deletar_visita_controller.php?id=<?= $_GET['id']?>" class="btn btn-danger">Excluir</a>
